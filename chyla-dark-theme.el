...
;;;;; diff-hl
   ...
   `(diff-hl-delete ((,class (:foreground ,chyla-dark-text :background ,chyla-dark-diff-removed-highlight))))
   `(diff-hl-insert ((,class (:foreground ,chyla-dark-text :background ,chyla-dark-diff-added-highlight))))
;;;;; dim-autoload
